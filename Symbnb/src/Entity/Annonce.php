...
class Annonce
{
    ...
    //ce qu'on fait dans les annotations, c'est de rendre obligatoire l'action de cette fonction avant tout persist ou update, i.e. entrée en bdd
    //si jamais il n'y a pas de slug
    /**
